...
const TAG_CARD_SET = {
    ...
    13: { id: 13, name: 'PE1', displayName: '地精大战侏儒' },
    14: { id: 14, name: 'BRM', displayName: '黑石山的火焰' },
    15: { id: 15, name: 'TGT', displayName: '冠军的试炼' },
    ...
    23: { id: 23, name: 'KARA', displayName: '卡拉赞之夜' },
    ...
    1001: { id: 1001, name: 'ICECROWN', displayName: '冰封王座的骑士' },
    ...
    1403: { id: 1403, name: 'YEAR_OF_THE_DRAGON', displayName: '迦拉克隆的觉醒' },
    1414: { id: 1414, name: 'BLACK_TEMPLE', displayName: '外域灰烬' },
    1439: { id: 1439, name: 'WILD_EVENT', displayName: '狂野模式活动' },
    ...
    1525: { id: 1525, name: 'THE_BARRENS', displayName: '贫瘠之地的锤炼' },
    1578: { id: 1578, name: 'STORMWIND', displayName: '暴风城下的集结' },
    1586: { id: 1586, name: 'LETTUCE', displayName: '佣兵战纪' },
    1626: { id: 1626, name: 'ALTERAC_VALLEY', displayName: '奥特兰克的决裂' },
    1635: { id: 1635, name: 'LEGACY', displayName: '怀旧' },
    1637: { id: 1637, name: 'CORE', displayName: '核心' },
    1646: { id: 1646, name: 'VANILLA', displayName: '经典' },
    1658: { id: 1658, name: 'THE_SUNKEN_CITY', displayName: '探寻沉没之城' },
    ...
    1809: { id: 1809, name: 'BATTLE_OF_THE_BANDS', displayName: '传奇音乐节' },
    1810: { id: 1810, name: 'CORE_HIDDEN', displayName: '核心（失效）' },
    1858: { id: 1858, name: 'TITANS', displayName: '泰坦诸神' },
    1869: { id: 1869, name: 'PATH_OF_ARTHAS', displayName: '阿尔萨斯之路' },
    1892: { id: 1892, name: 'WILD_WEST', displayName: '决战荒芜之地' },
    1897: { id: 1897, name: 'WHIZBANGS_WORKSHOP', displayName: '威兹班的工坊' },
    1898: { id: 1898, name: 'WONDERS', displayName: '时光之穴' },
    1904: { id: 1904, name: 'TUTORIAL', displayName: '教学' },
    1905: { id: 1905, name: 'ISLAND_VACATION', displayName: '胜地历险记' },
    1935: { id: 1935, name: 'SPACE', displayName: '深暗领域' },
    1941: { id: 1941, name: 'EVENT', displayName: '活动' },
    1946: { id: 1946, name: 'EMERALD_DREAM', displayName: '漫游翡翠梦境' },
    1952: { id: 1952, name: 'THE_LOST_CITY', displayName: '安戈洛龟途' },
    1957: { id: 1957, name: 'TIME_TRAVEL', displayName: '穿越时间流' },
